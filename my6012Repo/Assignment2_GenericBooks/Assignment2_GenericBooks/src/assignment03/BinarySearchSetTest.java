...
class BinarySearchSetTest {
    ...
    /*
    Test add integers to the set, and should be sorted with order
     */
    @Test
    void testAddInteger() {
    ...
    */
    ...
    void testContains() {
        ...
        Integer[] integersContainButMore = new Integer[] {20, 10, -5, 0, 100, 50};
        ...
        assertFalse(set_integer.containsAll(List.of(integersContainButMore)));
    }
