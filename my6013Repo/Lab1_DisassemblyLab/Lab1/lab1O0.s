...
; %bb.0:
	...
	str	w1, [sp, #8]
Ltmp1:
	.loc	8 4 10 prologue_end             ; lab1.cpp:4:10
	ldr	w8, [sp, #12]
	.loc	8 4 12 is_stmt 0                ; lab1.cpp:4:12
	ldr	w9, [sp, #8]
	.loc	8 4 11                          ; lab1.cpp:4:11
	add	w0, w8, w9
	.loc	8 4 3                           ; lab1.cpp:4:3
	add	sp, sp, #16
	ret
Ltmp2:
Lfunc_end0:
...
; %bb.0:
	...
	mov	w1, #1
Ltmp3:
	.loc	8 8 15 prologue_end             ; lab1.cpp:8:15
	bl	__Z3addii
	mov	x10, x0
	.loc	8 0 0 is_stmt 0                 ; lab1.cpp:0:0
	adrp	x0, l_.str@PAGE
	add	x0, x0, l_.str@PAGEOFF
	.loc	8 8 3                           ; lab1.cpp:8:3
	mov	x9, sp
                                        ; implicit-def: $x8
	mov	x8, x10
	str	x8, [x9]
	...
	.loc	8 9 3 is_stmt 1                 ; lab1.cpp:9:3
...
.set Lset4, Lfunc_end0-Lfunc_begin0     ; DW_AT_high_pc
	...
	.long	678                             ; DW_AT_type
                                        ; DW_AT_external
	.byte	27                              ; Abbrev [27] 0x7fb:0xe DW_TAG_formal_parameter
	.byte	2                               ; DW_AT_location
	.byte	145
	.byte	12
	.long	959                             ; DW_AT_name
	...
	.byte	3                               ; DW_AT_decl_line
	.long	678                             ; DW_AT_type
	.byte	27                              ; Abbrev [27] 0x809:0xe DW_TAG_formal_parameter
	.byte	2                               ; DW_AT_location
	.byte	145
	.byte	8
	.long	961                             ; DW_AT_name
	...
	.long	678                             ; DW_AT_type
	.byte	0                               ; End Of Children Mark
	.byte	28                              ; Abbrev [28] 0x818:0x19 DW_TAG_subprogram
...
.set Lset6, LNames2-Lnames_begin        ; Offset in Bucket 1
	.long	Lset6
